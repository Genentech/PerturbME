...
def main():
	...
	upregulation_p_high, upregulation_LFC_high = p_vals_by_target(target_names, target_to_cell_dict, HLA_upregulation_score, cond_names, 'High')
	plot_volcano(upregulation_LFC_high, upregulation_p_high, target_names, os.path.join(figures_pn, 'upregulation_HLA_sig_by_target_high.png'), title='HLA Up', FDR_correction=False, p_thresh=0.001, lfc_thresh=0.01, label_fontsize=4, draw_arrows=True)
	upregulation_p_low, upregulation_LFC_low = p_vals_by_target(target_names, target_to_cell_dict, HLA_upregulation_score, cond_names, 'Low')
	plot_volcano(upregulation_LFC_low, upregulation_p_low, target_names, os.path.join(figures_pn, 'upregulation_HLA_sig_by_target_low.png'), title='HLA Up', FDR_correction=False, p_thresh=0.001, lfc_thresh=0.01, label_fontsize=4, draw_arrows=True)

	downregulation_p_high, downregulation_LFC_high = p_vals_by_target(target_names, target_to_cell_dict, HLA_downregulation_score, cond_names, 'High')
	plot_volcano(downregulation_LFC_high, downregulation_p_high, target_names, os.path.join(figures_pn, 'downregulation_HLA_sig_by_target_high.png'), title='HLA Down', FDR_correction=False, p_thresh=0.001, lfc_thresh=0.01, label_fontsize=5, draw_arrows=True)
	downregulation_p_low, downregulation_LFC_low = p_vals_by_target(target_names, target_to_cell_dict, HLA_downregulation_score, cond_names, 'Low')
	plot_volcano(downregulation_LFC_low, downregulation_p_low, target_names, os.path.join(figures_pn, 'downregulation_HLA_sig_by_target_low.png'), title='HLA Down', FDR_correction=False, p_thresh=0.001, lfc_thresh=0.01, label_fontsize=5, draw_arrows=True)

	composite_p_high, composite_LFC_high = p_vals_by_target(target_names, target_to_cell_dict, HLA_composite_score, cond_names, 'High')
	plot_volcano(composite_LFC_high, composite_p_high, target_names, os.path.join(figures_pn, 'composite_HLA_sig_by_target_high.png'), title='HLA Composite', FDR_correction=False, p_thresh=0.001, lfc_thresh=0.01, label_fontsize=4, draw_arrows=True)
	composite_p_low, composite_LFC_low = p_vals_by_target(target_names, target_to_cell_dict, HLA_composite_score, cond_names, 'Low')
	plot_volcano(composite_LFC_low, composite_p_low, target_names, os.path.join(figures_pn, 'composite_HLA_sig_by_target_low.png'), title='HLA Composite', FDR_correction=False, p_thresh=0.001, lfc_thresh=0.01, label_fontsize=4, draw_arrows=True)
